                            ...
                            <table class="table table-light table-light-success mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-center">{{ $companyCategory->id }}</td>
                                    </tr>
                                    @foreach($locales as $locale)
                                    <tr>
                                        <td class="table-row-title w-25">Ad ({{ str($locale)->upper() }})</td>
                                        <td class="table-center">{{ $companyCategory->{"name:$locale"} }}</td>
                                    </tr>
                                    @endforeach
                                    <tr>
                                        <td class="table-row-title w-25">Status</td>
                                        <td class="table-center">{!! $companyCategory->status_label !!}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                <a href="{{ route('backend.company_categories.edit', $companyCategory) }}" class="btn btn-primary mr-2">Redaktə et</a>
