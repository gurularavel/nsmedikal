...
class UpdateNewsArticleRequest extends TranslateRequest
{
    ...
    {
        foreach ($this->getLocales() as $locale) {
            $this->translateRules["title:$locale"] = ['required', 'max:555'];
            $this->translateRules["description:$locale"] = ['nullable'];
            $this->translateRules["content:$locale"] = ['required', 'string'];
