        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ route('backend.company_categories.update', $companyCategory) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input
                                                        ...
                                                        name="name:{{ $locale }}"
                                                        value="{{ old("name:$locale", $companyCategory) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        >
                                            <option value=""></option>
                                            <option value="1" @selected(old('status', $companyCategory) == 1)>Aktiv</option>
                                            <option value="0" @selected(old('status', $companyCategory) == 0 && is_numeric(old('status', $companyCategory)))>Deaktiv</option>
                                        </select>
                                        @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
