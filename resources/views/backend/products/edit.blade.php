                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input
                                                        ...
                                                        name="name:{{ $locale }}"
                                                        value="{{ old("name:$locale", $product->{"name:$locale"}) }}"
                                    ...
                                    <div class="input-group">
                                        ...
                                        >
                                            ...
                                            @foreach($productCategories as $productCategory)
                                                <option @selected(old('product_category_id', $product) == $productCategory->id)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        >
                                            <option value=""></option>
                                            <option value="1" @selected(old('status', $product) == 1)>Aktiv</option>
                                            <option
                                                value="0" @selected(old('status', $product) == 0 && is_numeric(old('status', $product)))>
                                                Deaktiv
                                            </option>
                                        </select>
                                        @error('status')
