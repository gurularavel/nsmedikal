                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('backend.products.create') }}" class="btn btn-primary font-weight-bolder">
                                <i class="la la-plus"></i> Yeni məhsul
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $product->id }}</td>
                                        <td><img src="{{ asset("uploads/products/$product->image") }}" style="width: 150px"></td>
                                        <td>{{ $product->name }}</td>
                                        <td>{{ $product->productCategory?->name }}</td>
                                        <td>{!! $product->status_label !!}</td>
                                        <td>
                                            <a href="{{ route('backend.products.show', $product) }}" class="btn btn-sm btn-icon btn-clean mr-2">
                                                <i class="la la-cog"></i>
                                            </a>
                                            <a href="{{ route('backend.products.edit', $product) }}" class="btn btn-sm btn-icon btn-clean mr-2">
