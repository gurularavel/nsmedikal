        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ route('backend.companies.update', $company) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <textarea
                                                        ...
                                                        rows="12">
                                                        {{ old("description:$locale", $company) }}
                                                    </textarea>
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input
                                                        ...
                                                        value="{{ old("products:$locale", $company) }}"
                                    ...
                                    <div class="input-group">
                                        ...
                                        >
                                            ...
                                            @foreach($companyCategories as $companyCategory)
                                                <option @selected(old('company_category_id', $company) == $companyCategory->id)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        >
                                            <option value=""></option>
                                            <option value="1" @selected(old('status', $company) == 1)>Aktiv</option>
                                            <option
                                                value="0" @selected(old('status', $company) == 0 && is_numeric(old('status', $company)))>
                                                Deaktiv
                                            </option>
                                        </select>
                                        @error('status')
