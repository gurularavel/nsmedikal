                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        >
                                            <option value=""></option>
                                            <option value="1" @selected(old('main_page_show') == 1)>Bəli</option>
                                            <option value="0" @selected(old('main_page_show') == 0 && is_numeric(old('main_page_show')))>Xeyr</option>
                                        </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                        ...
                                        >
                                            <option value=""></option>
                                            <option value="1" @selected(old('products_page_show') == 1)>Bəli</option>
                                            <option value="0" @selected(old('products_page_show') == 0 && is_numeric(old('products_page_show')))>Xeyr</option>
                                        </select>
...
@push('scripts')
    <script>
        ...
        $('select[name="products_page_show"]').select2({
            placeholder: 'Seçin',
        });
        $('select[name="main_page_show"]').select2({
            placeholder: 'Seçin',
        });
    </script>
@endpush
